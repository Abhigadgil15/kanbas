...
export default function AssignmentAlgorithms({ aid }) {
    const assignmentData = {
        1: {
          name: "A1 - Print overlapping rectangels in set",
          description: "Write functions to count overlapping rectangles ",
          points: 100,
          gradeType: "percent",
          ...
          assignedTo: "everyone",
          dueDate: "2024-05-19",
          dateRange: { from: "2024-05-12", to: "2024-05-19" }
        },
        2: {
          name: "A2 - Object oriented programming",
          description: "Create a function that accurately creates an object for above functiom",
          points: 50,
          gradeType: "percent",
          submissionType: "online",
          ...
          assignedTo: "everyone",
          dueDate: "2024-06-07",
          dateRange: { from: "2024-06-21", to: "2024-06-07" }
        },
        3: {
          name: "A3 - Designing and functional programming",
          description: "To write comments in javadoc files",
          points: 100,
          gradeType: "percent",
          submissionType: "online",
          ...
          assignedTo: "everyone",
          dueDate: "2024-06-21",
          dateRange: { from: "2024-06-21", to: "2024-07-01" }
        }
      };
