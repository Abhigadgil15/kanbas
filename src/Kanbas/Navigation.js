...
export default function KanbasNavigation() {
  return (
    <div id="wd-kanbas-navigation">
      <a rel="noopener noreferrer" href="https://www.northeastern.edu/" id="wd-neu-link" target="_blank">Northeastern</a><br/>
      ...
      <Link to="https://github.com/Abhigadgil15/kanbas/tree/assi1">Github</Link>
    </div>
);}
