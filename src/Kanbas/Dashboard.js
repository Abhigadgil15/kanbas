...
export default function Dashboard({
  ...
  ? courses // Faculty can see all published courses
  ...
  return (
    <div id="wd-dashboard">
      ...
      {/* Check if the current user is a FACULTY to show editing options */}
      ...
      <h2 id="wd-dashboard-published">{currentUser.role === "FACULTY" ? "Published Courses" : "Enrolled Courses"} ({displayedCourses.length})</h2>
      <hr />
